    ...
    public class MaterialRepository : IMaterialRepository
    {
        ...
        public void InsertFactory(Fabricantes fabricantes, int idContent)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstr))
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("carga.InsertFabricanteJson", conn);
                    //FABRICANTE
                    cmd.Parameters.Add(new SqlParameter("@cont_content_id", idContent));
                    cmd.Parameters.Add(new SqlParameter("@fab_atividade", fabricantes.atividade));
                    cmd.Parameters.Add(new SqlParameter("@fab_razaosocial", fabricantes.razaoSocial));
                    cmd.Parameters.Add(new SqlParameter("@fab_pais", fabricantes.pais));
                    cmd.Parameters.Add(new SqlParameter("@fab_local", fabricantes.local));
